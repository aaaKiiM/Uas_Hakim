        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card card-primary">
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="/toko/edit/{{ $toko->id }}" method="POST">
                        @csrf
                        @method("PUT")
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">User</label>
                                <select name="user" class="custom-select" id="exampleSelectBorder">
                                    <option>Pilih User</option>
                                    @foreach ($user as $item)
                                        <option value="{{ $item->id }}" {{ $toko->users_id=$item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Nama Toko</label>
                                <input type="text" value="{{ $toko->nama_toko }}" name="nama" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Alamat Toko</label>
                                <input type="text" value="{{ $toko->alamat_toko }}" name="alamat" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">No HP Toko</label>
                                <input type="text" value="{{ $toko->no_hp_toko }}" name="hp" class="form-control">
                            </div>
                        </div>
                        <!-- /.card-body -->
