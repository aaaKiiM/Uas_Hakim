                    ...
                    <form action="/toko/store" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="alamat" class="form-control" placeholder="Masukkan Nama Toko">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">No HP Toko</label>
                                <input type="text" name="hp" class="form-control" placeholder="Masukkan Nama Toko">
                            </div>
                        </div>
                        <!-- /.card-body -->
